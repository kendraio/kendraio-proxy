// Forked from the CORS Anywhere proxy by Rob Wu <rob@robwu.nl>
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    // App.kendra.io uses the target-url header 
    ...
    if (corsAnywhere.destinationAllowlist.length && corsAnywhere.destinationAllowlist.indexOf(location.hostname) === -1) {
